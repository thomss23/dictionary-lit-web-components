...
/**
     ...
     * SPDX-License-Identifier: BSD-3-Clause
     */
const ct=2;class lt{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}
/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */const{D:dt}=nt,pt=()=>document.createComment(""),ut=(t,e,i)=>{const s=t._$AA.parentNode,o=void 0===e?t._$AB:e._$AA;if(void 0===i){const e=s.insertBefore(pt(),o),n=s.insertBefore(pt(),o);i=new dt(e,n,t,t.options)}else{const e=i._$AB.nextSibling,n=i._$AM,r=n!==t;if(r){let e;i._$AQ?.(t),i._$AM=t,void 0!==i._$AP&&(e=t._$AU)!==n._$AU&&i._$AP(e)}if(e!==o||r){let t=i._$AA;for(;t!==e;){const e=t.nextSibling;s.insertBefore(t,o),t=e}}}return i},ft=(t,e,i=t)=>(t._$AI(e,i),t),gt={},mt=t=>{t._$AP?.(!1,!0);let e=t._$AA;const i=t._$AB.nextSibling;for(;e!==i;){const t=e.nextSibling;e.remove(),e=t}},vt=(t,e,i)=>{const s=new Map;for(let o=e;o<=i;o++)s.set(t[o],o);return s},xt=(t=>(...e)=>({_$litDirective$:t,values:e}))(class extends lt{constructor(t){if(super(t),t.type!==ct)throw Error("repeat() can only be used in text expressions")}ht(t,e,i){let s;void 0===i?i=e:void 0!==e&&(s=e);const o=[],n=[];let r=0;for(const e of t)o[r]=s?s(e,r):r,n[r]=i(e,r),r++;return{values:n,keys:o}}render(t,e,i){return this.ht(t,e,i).values}update(t,[e,i,s]){const o=(t=>t._$AH)(t),{values:n,keys:r}=this.ht(e,i,s);if(!Array.isArray(o))return this.dt=r,n;const h=this.dt??=[],a=[];let c,l,d=0,p=o.length-1,u=0,f=n.length-1;for(;d<=p&&u<=f;)if(null===o[d])d++;else if(null===o[p])p--;else if(h[d]===r[u])a[u]=ft(o[d],n[u]),d++,u++;else if(h[p]===r[f])a[f]=ft(o[p],n[f]),p--,f--;else if(h[d]===r[f])a[f]=ft(o[d],n[f]),ut(t,a[f+1],o[d]),d++,f--;else if(h[p]===r[u])a[u]=ft(o[p],n[u]),ut(t,o[d],o[p]),p--,u++;else if(void 0===c&&(c=vt(r,u,f),l=vt(h,d,p)),c.has(h[d]))if(c.has(h[p])){const e=l.get(r[u]),i=void 0!==e?o[e]:null;if(null===i){const e=ut(t,o[d]);ft(e,n[u]),a[u]=e}else a[u]=ft(i,n[u]),ut(t,o[d],i),o[e]=null;u++}else mt(o[p]),p--;else mt(o[d]),d++;for(;u<=f;){const e=ut(t,a[f+1]);ft(e,n[u]),a[u++]=e}for(;d<=p;){const t=o[d++];null!==t&&mt(t)}return this.dt=r,((t,e=gt)=>{t._$AH=e})(t,a),W}});
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
...
`;class St extends ht{static styles=[$t];static properties={isDarkMode:{type:Boolean}};handleToggle(){const t=new CustomEvent("toggle-mode",{bubbles:!0,composed:!0});this.dispatchEvent(t)}render(){return H`
            <label class="switch">
                <input type="checkbox" @change="${this.handleToggle}" ?checked="${this.isDarkMode}">
                <span class="slider round"></span>
            </label>
        `}}window.customElements.define("toggle-switch-element",St);var kt=r`
    .dropdown {
        border-radius: 10px;
...
`;customElements.define("font-dropdown-element",class extends ht{static styles=[kt];render(){return H`
            <div class="dropdown">
        ...
        `}selectFont(t){this.dispatchEvent(new CustomEvent("font-selected",{detail:t,composed:!0,bubbling:!0}))}});const Mt=r`
...
`;class Ct extends ht{get styles(){return r`
        ...
        `}}window.customElements.define("header-element",Ct);const _t=r`
    input {
        box-sizing: border-box; 
        width: 100%;
        height: 50px;
...
`;class Tt extends ht{get styles(){return r`
            ${_t}

            ${this.isDarkMode?Dt:Et}
        ...
        `}}window.customElements.define("searchbar-component",Tt);var zt=r`
    .error-container {
            width:100%;
            display:flex;
            justify-content: space-between;
...
`;customElements.define("error-element",class extends ht{static styles=[zt];static properties={error:{type:Object}};constructor(){super(),this.error={}}render(){return H`
...
`;class Ot extends ht{static styles=[jt];static properties={data:{type:Object},error:{type:Object},fontType:{type:String},isDarkMode:{type:Boolean}};constructor(){super(),this.data=null,this.error=null}async handleSearch(t){const e=t.detail;try{const t=await async function(t){const e="https://api.dictionaryapi.dev/api/v2/entries/en/"+t,i=await fetch(e);if(!i.ok){const t=await i.json();throw{status:i.status,message:"HTTP error",details:t}}return i.json()}(e);this.data=t,this.error=null}catch(t){this.data=null,this.error=t.details}}async handleEnter(t){await this.handleSearch(t)}render(){return console.log("Main"+this.isDarkMode),this.error?H`
      ...
      `}}window.customElements.define("main-element",Ot);class Ut extends ht{static properties={fontType:{type:String},isDarkMode:{type:Boolean}};constructor(){super(),this.fontType="Sans Serif",this.isDarkMode=!1,this.addEventListener("font-selected",this.handleSelectedFont),this.addEventListener("toggle-mode",this.handleToggleMode)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("toggle-mode",this.handleToggleMode)}handleToggleMode(){this.isDarkMode=!this.isDarkMode,this.isDarkMode?document.body.style.backgroundColor="#050505":document.body.style.backgroundColor="#FFFFFF"}handleSelectedFont(t){this.fontType=t.detail}render(){return console.log("AppContainer"+this.isDarkMode),H`
      <style>
        :host {
    ...
    `}}window.customElements.define("app-container",Ut),t.AppContainer=Ut,Object.defineProperty(t,"i",{value:!0})}({});
