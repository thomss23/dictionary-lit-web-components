...
`;class _t extends ht{get styles(){return r`
            ${Mt}
        ...
        `}}window.customElements.define("header-element",_t);const Ct=r`
    input {
        box-sizing: border-box; 
        width: 100%;
        height: 50px;
