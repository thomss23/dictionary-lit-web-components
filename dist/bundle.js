...
`;class Ft extends ht{get styles(){return r`
            ${kt}

            ${this.isDarkMode?At:Mt}
        ...
        `}}window.customElements.define("header-element",Ft);const Ct=r`
    input {
        box-sizing: border-box; 
        width: 100%;
        height: 50px;
...
`;class Dt extends ht{get styles(){return r`
            ${Ct}

            ${this.isDarkMode?Et:_t}
        ...
        `}}window.customElements.define("searchbar-component",Dt);var Tt=r`
    .error-container {
            width:100%;
            display:flex;
            justify-content: space-between;
...
`;class jt extends ht{static styles=[zt];static properties={data:{type:Object},error:{type:Object},fontType:{type:String},isDarkMode:{type:Boolean}};constructor(){super(),this.data=null,this.error=null}async handleSearch(t){const e=t.detail;try{const t=await async function(t){const e="https://api.dictionaryapi.dev/api/v2/entries/en/"+t,i=await fetch(e);if(!i.ok){const t=await i.json();throw{status:i.status,message:"HTTP error",details:t}}return i.json()}(e);this.data=t,this.error=null}catch(t){this.data=null,this.error=t.details}}async handleEnter(t){await this.handleSearch(t)}render(){return console.log("Main"+this.isDarkMode),this.error?H`
    ...
    `}}window.customElements.define("app-container",Ot),t.AppContainer=Ot,Object.defineProperty(t,"i",{value:!0})}({});
