...
`;window.customElements.define("definition-element",class extends at{static properties={meaning:{type:Object}};constructor(){super(),this.meaning=null}static styles=[yt];render(){return H`
...
`;window.customElements.define("loading-element",class extends at{static styles=[bt];render(){return H`
        <div class="lds-ring">
            <div>
            </div>
            <div>
...
`:""}
        ...
        `}}window.customElements.define("content-element",$t);var kt=r`
    .separator {
...
`;window.customElements.define("footer-element",class extends at{static styles=[kt];static properties={sourceURL:{type:String}};constructor(){super(),this.url=""}render(){return H`
...
`;class Mt extends at{static styles=[St];static properties={isDarkMode:{type:Boolean}};handleToggle(){const t=new CustomEvent("toggle-mode",{bubbles:!0,composed:!0});this.dispatchEvent(t)}render(){return H`
            <label class="switch">
                <input type="checkbox" @change="${this.handleToggle}" ?checked="${this.isDarkMode}">
                <span class="slider round"></span>
            </label>
        `}}window.customElements.define("toggle-switch-element",Mt);var At=r`
    .dropdown {
        border-radius: 10px;
        box-sizing: border-box; 
        position: absolute;
...
`;customElements.define("font-dropdown-element",class extends at{static styles=[At];render(){return H`
            <div class="dropdown">
        ...
        `}selectFont(t){this.dispatchEvent(new CustomEvent("font-selected",{detail:t,composed:!0,bubbling:!0}))}});const Ft=r`
...
`;class Et extends at{get styles(){return r`
        ...
        `}}window.customElements.define("header-element",Et);const Dt=r`
    input {
        box-sizing: border-box; 
        width: 100%;
        height: 50px;
...
`;class jt extends at{get styles(){return r`
            ${Dt}

            ${this.isDarkMode?zt:Tt}
        ...
        `}}window.customElements.define("searchbar-component",jt);var Ot=r`
    .error-container {
            width:100%;
            display:flex;
            justify-content: space-between;
...
`;customElements.define("error-element",class extends at{static styles=[Ot];static properties={error:{type:Object}};constructor(){super(),this.error={}}render(){return H`
...
`;class Pt extends at{static styles=[Ut];static properties={data:{type:Object},error:{type:Object},fontType:{type:String},isDarkMode:{type:Boolean},isLoading:{type:Boolean}};constructor(){super(),this.data=null,this.error=null,this.isLoading=!1}async handleSearch(t){const e=t.detail;try{this.isLoading=!0;const t=await async function(t){const e="https://api.dictionaryapi.dev/api/v2/entries/en/"+t,i=await fetch(e);if(!i.ok){const t=await i.json();throw{status:i.status,message:"HTTP error",details:t}}return i.json()}(e);this.data=t,this.error=null}catch(t){this.data=null,this.error=t.details}finally{this.isLoading=!1}}async handleEnter(t){await this.handleSearch(t)}render(){return this.error?H`
    ...
    `}}window.customElements.define("app-container",Rt),t.AppContainer=Rt,Object.defineProperty(t,"i",{value:!0})}({});
